...
function ProductsTable() {
    ...
    const deleteFurniture = async (id) => {
        const res = await axios.delete(`${baseUrl}/furniture/delete-furniture/${id}`, {
            headers: {
                        ...
                        <tbody class="divide-y">
                            <tr key={furniture.id} class="hover:bg-gray-50 transition" >
                                ...
                                <td class="p-4 text-right">
                                    ...
                                    <button onClick={deleteFurniture(furniture._id)} class="text-red-500 hover:underline" > Delete</button>
                                </td>
                            </tr>
                        </tbody>
                    );
